...
class BiasInBiosTask(Task):
    ...
    def __init__(self, 
        ...
        if demographic_field != "gender":
            raise ValueError("demographic_field specified as not gender which is not supported in BiasInBios")
    ...
    def get_val_examples(self):
        dev = self._create_examples(lines=read_jsonl(self.val_path), set_type="val")
        self.dev_size = len(dev)
        return dev
